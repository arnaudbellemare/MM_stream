...
- The core of the app now uses a professional, two-step ZigZag algorithm to find swing points and define market regimes. This is a much more robust and reliable method.
""")
